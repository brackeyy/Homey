...
flat1 = Flat.create!(user: user1, title: 'Spacious Loft in Barcelona', city: "Barcelona", price: 250, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
file2 = URI.open('https://images.pexels.com/photos/584399/living-room-couch-interior-room-584399.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
file3 = URI.open('https://images.pexels.com/photos/1879061/pexels-photo-1879061.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
flat3 = Flat.create!(user: user1, title: 'Cosy flat + rooftop terrasse', city: "Barcelona", price: 170, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
flat4 = Flat.create!(user: user1, title: 'Urban villa in city center', city: "Barcelona", price: 150, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
file5 = URI.open('https://images.pexels.com/photos/3581753/pexels-photo-3581753.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
file6 = URI.open('https://images.pexels.com/photos/3597114/pexels-photo-3597114.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
flat5 = Flat.create!(user: user3, title: 'Industrial Loft in El Gótico', city: "Barcelona", price: 190, description: "Moin, my name is Linda and I am looking for YOU NIKLAS! So if you read this, slide in my DMsssss... ;)", laundry: true, sexy_time: true, cooking: true)
...
file5 = URI.open('https://images.pexels.com/photos/3581753/pexels-photo-3581753.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
file6 = URI.open('https://images.pexels.com/photos/3597114/pexels-photo-3597114.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
flat6 = Flat.create!(user: user2, title: 'Old appartment + jacuzzi', city: "Barcelona", price: 200, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
flat7 = Flat.create!(user: user2, title: 'Best flat ever', city: "Barcelona", price: 120, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
file8 = URI.open('https://images.pexels.com/photos/3679601/pexels-photo-3679601.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
file9 = URI.open('https://images.pexels.com/photos/3875428/pexels-photo-3875428.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
flat8 = Flat.create!(user: user2, title: 'Bar-style appartment', city: "Barcelona", price: 250, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
file8 = URI.open('https://images.pexels.com/photos/3679601/pexels-photo-3679601.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
file9 = URI.open('https://images.pexels.com/photos/3875428/pexels-photo-3875428.jpeg?auto=compress&cs=tinysrgb&dpr=2&w=500')
flat9 = Flat.create!(user: user2, title: 'Underground appartment', city: "Barcelona", price: 270, description: "Hi, my name is Alf. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
