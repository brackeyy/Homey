...
flat6 = Flat.create!(user: user1, title: 'Old appartment + jacuzzi', city: "Barcelona", price: 200, description: "Hi, my name is Lucia. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
flat7 = Flat.create!(user: user1, title: 'Best flat ever', city: "Barcelona", price: 120, description: "Hi, my name is Lucia. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
flat8 = Flat.create!(user: user1, title: 'Bar-style appartment', city: "Barcelona", price: 250, description: "Hi, my name is Lucia. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
...
flat9 = Flat.create!(user: user1, title: 'Underground appartment', city: "Barcelona", price: 270, description: "Hi, my name is Lucia. I'm 74 years old and as my husband passed away 3 years ago I am feeling very lonely. ;) Looking for a nice student to share my flat with and have some deeeeep convos...", groceries: true, sexy_time: true, cooking: true)
